...
ppt_path = r"C:\Users\DELL\Downloads\DOC-20241114-WA0026..pptx"
...
# Function to check if thumb, ring, and little fingers are raised (for exit gesture)
def is_thumb_ring_little_raised(hand_landmarks):
    return (
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Exit PowerPoint if thumb, ring, and little fingers are raised
            if is_thumb_ring_little_raised(hand_landmarks):
